# Contributing to Event Emitter 🔊

We’re excited that you’re interested in contributing to Event Emitter! This guide will help you get started.
...
- Search Existing Issues: Check the [Issues](https://github.com/alessiofrittoli/event-emitter/issues) tab to see if your concern has already been addressed.
...
- Go to the [repository page](https://github.com/alessiofrittoli/event-emitter).
- Click the Fork button.
- Clone your fork to your local machine:

```bash
git clone https://github.com/your-username/event-emitter.git
```
...
Thank you for helping improve Event Emitter! 🎉
